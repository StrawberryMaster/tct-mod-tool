...
(function () {
    ...
    const THEME_ORDER = ['light', 'sepia', 'dark', 'mallard', 'xp-olive', 'xp-silver', 'xp-zune', 'xp-royale-dark'];
    const THEME_CONFIGS = {
        light: {
            themeColor: '#2563eb',
            cssVars: {
        ...
        sepia: {
            ...
            cssVars: {
                ...
                '--control-primary-text': '#111827',
                '--control-primary-hover': '#a86a1c',
                '--control-accent-bg': '#c28539',
                '--control-accent-text': '#111827',
        ...
        'xp-zune': {
            ...
            cssVars: {
                '--app-bg': '#121212',
                '--app-panel-bg': '#1a1a1a',
                '--app-editor-bg': '#161616',
                '--app-text': '#e5e7eb',
                '--card-bg': 'rgba(38, 38, 38, 0.85)',
                '--muted-surface': '#2d2d2d',
                '--input-bg': '#121212',
                '--border-color': '#404040',
                '--brand-start': '#111111',
                '--brand-end': '#262626',
                '--header-contrast': '#ffffff',
                '--footer-bg': 'rgba(224, 90, 16, 0.95)',
                '--toolbar-header-start': '#111111',
                '--toolbar-header-end': '#262626',
                '--toolbar-header-text': '#ffffff',
                '--toolbar-panel-bg': '#1e1e1e',
                '--toolbar-panel-border': '#404040',
                '--control-bg': '#2d2d2d',
                '--control-bg-hover': '#404040',
                '--control-text': '#e5e7eb',
                '--control-primary-bg': '#e05a10',
                '--control-primary-text': '#111827',
                '--control-primary-hover': '#b8460a',
                '--control-accent-bg': '#e05a10',
                '--control-accent-text': '#111827',
                '--utility-bg-white': '#1a1a1a',
                '--utility-bg-white-90': 'rgba(26, 26, 26, 0.9)',
                '--utility-bg-gray-50': '#222222',
                '--utility-bg-gray-100': '#181818',
                '--utility-bg-gray-200': '#1e1e1e',
                '--utility-bg-gray-300': '#2d2d2d',
                '--utility-bg-blue-50': '#3d2218',
                '--utility-bg-indigo-200': '#2d2a45',
                '--utility-bg-purple-200': '#2d2a45',
                '--utility-hover-gray-50': '#2d2d2d',
                '--utility-hover-gray-100': '#2d2d2d',
                '--utility-hover-gray-300': '#404040',
                '--utility-hover-gray-400': '#404040',
                '--utility-hover-gray-500': '#404040',
                '--utility-hover-gray-600': '#404040',
                '--utility-text-gray': '#d1d5db',
                '--utility-text-black': '#d1d5db',
                '--utility-hover-text-black': '#ffffff',
                '--utility-hover-text-gray': '#ffffff',
                '--utility-border': '#404040',
                '--utility-input-bg': '#121212',
                '--utility-input-text': '#e5e7eb',
                '--utility-input-border': '#404040',
                '--utility-input-placeholder': '#737373',
                '--utility-input-focus': '#e05a10',
                '--utility-shadow': '0 2px 4px rgba(0, 0, 0, 0.5)',
                '--map-bg': '#0f0f14',
                '--map-fill': '#ff8a4d',
                '--map-stroke': '#ffffff',
                '--score-positive': '#22c55e',
                '--score-negative': '#ef4444',
                '--gradient-from-blue': '#e05a10',
                '--gradient-to-blue': '#b8460a',
                '--gradient-from-blue-hover': '#b8460a',
                '--gradient-to-blue-hover': '#913305',
                '--gradient-from-green': '#10b981',
                '--gradient-to-green': '#059669',
                '--gradient-from-green-hover': '#059669',
                '--gradient-to-green-hover': '#047857',
                '--gradient-from-purple': '#8b5cf6',
                '--gradient-to-purple': '#7c3aed',
                '--gradient-from-purple-hover': '#7c3aed',
                '--gradient-to-purple-hover': '#6d28d9',
                '--gradient-from-orange': '#f97316',
                '--gradient-to-orange': '#ea580c',
                '--gradient-from-orange-hover': '#ea580c',
                '--gradient-to-orange-hover': '#c2410c',
                ...
                '--text-green-600': '#4ade80',
                '--banner-bg': '#1f1f1f',
                '--banner-border': '#e05a10',
                '--cyoa-popup-bg': '#121212',
                '--cyoa-popup-border': '#404040',
                '--cyoa-popup-text': '#e5e7eb',
                '--cyoa-popup-h3-border': '#404040',
                '--tier-low': '#ef4444',
                '--tier-mid': '#525252',
                '--tier-high': '#22c55e'
            },
            mapPalette: {
                positive: ['#301f14', '#452718', '#5b311b', '#733b1e', '#8c4521', '#a65123', '#c05c25', '#db6927', '#f67628', '#ff842a'],
                negative: ['#1e1f30', '#212445', '#242a5a', '#262f70', '#273487', '#273aa0', '#243fb9', '#1d44d3', '#0d48ed', '#004cff'],
                neutral: '#2d2d2d'
            },
            stateMetricPalette: {
                positive: ['#301f14', '#5b311b', '#8c4521', '#c05c25', '#f67628'],
                negative: ['#1e1f30', '#242a5a', '#273487', '#243fb9', '#0d48ed'],
                neutral: '#262626'
            },
            stateStroke: {
                selected: '#ffffff',
        ...
        'xp-royale-dark': {
            ...
            cssVars: {
                '--app-bg': '#070b19',
                '--app-panel-bg': '#0f142b',
                '--app-editor-bg': '#0b0f24',
                '--app-text': '#f1f5f9',
                '--card-bg': 'rgba(18, 24, 48, 0.85)',
                '--muted-surface': '#1b2347',
                '--input-bg': '#070b19',
                '--border-color': '#2a3668',
                '--brand-start': '#050714',
                '--brand-end': '#0055ff',
                '--header-contrast': '#ffffff',
                '--footer-bg': 'rgba(0, 85, 255, 0.95)',
                '--toolbar-header-start': '#050714',
                '--toolbar-header-end': '#0055ff',
                '--toolbar-header-text': '#ffffff',
                '--toolbar-panel-bg': '#121836',
                '--toolbar-panel-border': '#2a3668',
                '--control-bg': '#1b2347',
                '--control-bg-hover': '#242f5e',
                '--control-text': '#f1f5f9',
                '--control-primary-bg': '#0055ff',
                '--control-primary-text': '#ffffff',
                '--control-primary-hover': '#0044dd',
                '--control-accent-bg': '#00d4ff',
                '--control-accent-text': '#070b19',
                '--utility-bg-white': '#0f142b',
                '--utility-bg-white-90': 'rgba(15, 20, 43, 0.9)',
                '--utility-bg-gray-50': '#151b3a',
                '--utility-bg-gray-100': '#0d1128',
                '--utility-bg-gray-200': '#121836',
                '--utility-bg-gray-300': '#1b2347',
                '--utility-bg-blue-50': '#0f244a',
                '--utility-bg-indigo-200': '#231e4d',
                '--utility-bg-purple-200': '#231e4d',
                '--utility-hover-gray-50': '#1b2347',
                '--utility-hover-gray-100': '#1b2347',
                '--utility-hover-gray-300': '#2a3668',
                '--utility-hover-gray-400': '#2a3668',
                '--utility-hover-gray-500': '#2a3668',
                '--utility-hover-gray-600': '#2a3668',
                '--utility-text-gray': '#cbd5e1',
                '--utility-text-black': '#cbd5e1',
                '--utility-hover-text-black': '#ffffff',
                '--utility-hover-text-gray': '#ffffff',
                '--utility-border': '#2a3668',
                '--utility-input-bg': '#070b19',
                '--utility-input-text': '#f1f5f9',
                '--utility-input-border': '#2a3668',
                '--utility-input-placeholder': '#4a578c',
                '--utility-input-focus': '#0055ff',
                '--utility-shadow': '0 2px 4px rgba(0, 0, 0, 0.55)',
                '--map-bg': '#040712',
                '--map-fill': '#4d88ff',
                '--map-stroke': '#ffffff',
                '--score-positive': '#10b981',
                '--score-negative': '#ef4444',
                '--gradient-from-blue': '#00d4ff',
                '--gradient-to-blue': '#0055ff',
                '--gradient-from-blue-hover': '#0055ff',
                '--gradient-to-blue-hover': '#0044dd',
                '--gradient-from-green': '#10b981',
                '--gradient-to-green': '#059669',
                '--gradient-from-green-hover': '#059669',
                '--gradient-to-green-hover': '#047857',
                ...
                '--text-green-600': '#4ade80',
                '--banner-bg': '#0f142b',
                '--banner-border': '#0055ff',
                '--cyoa-popup-bg': '#070b19',
                '--cyoa-popup-border': '#2a3668',
                '--cyoa-popup-text': '#f1f5f9',
                '--cyoa-popup-h3-border': '#2a3668',
                '--tier-low': '#ef4444',
                '--tier-mid': '#2a3668',
                '--tier-high': '#10b981'
            },
            mapPalette: {
                positive: ['#0a1d40', '#0a2654', '#0d3269', '#103f7e', '#134e94', '#155da9', '#166dbf', '#157ed5', '#0f8feb', '#00a0ff'],
                negative: ['#3a1020', '#4d1326', '#61162c', '#761932', '#8c1c38', '#a31e3d', '#b91f42', '#d01e46', '#e71a4a', '#ff124d'],
                neutral: '#1b2347'
            },
            stateMetricPalette: {
                positive: ['#0a1d40', '#0d3269', '#134e94', '#166dbf', '#0f8feb'],
                negative: ['#3a1020', '#61162c', '#8c1c38', '#b91f42', '#e71a4a'],
                neutral: '#121836'
            },
            stateStroke: {
                selected: '#ffffff',
...
class TCTData {
    ...
    getStateTransformJavascriptForMapping() {
        ...
        for (let i = 0; i < states.length; i++) {
            ...
            parts.push(
                `"${state.fields.abbr}":"${String(transform)
                    .replaceAll("\\", "\\\\")
                    .replaceAll('"', '\\"')}"`
            );
        }
